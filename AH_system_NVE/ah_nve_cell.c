...
const int    max_step = (int) 0.5e4;                     /* No. of steps simulation run -- */
...
int main()
{
    ...
    int swit = 0;   // switch to control whether final config reads/write
    double temp;
    ...
    FILE *fid;
    fid = fopen("Energy_data_N128_rho1.20_K1.0_dt0.002", "w");
    ...
    for (int step = 0; step < max_step; step++)
    {
        ...
        fprintf(fid, "%d\t %.12lf\t %.12lf\t %.12lf\t %.12lf\t %.12lf\n ", 
