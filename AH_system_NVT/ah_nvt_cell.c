...
int main()
{
    ...
    int start_Eavg = (int) (max_step - 2e3);
    int stop_Eavg = (int) (max_step - 1e3);
    ...
    FILE *fid1, *fid2, *fid3;
    fid1 = fopen("Energy_data_NVT_N127_rho0.20_K1.0_dt0.001", "w");
    fid2 = fopen("Temperature_NVT_N127_rho0.20_K1.0_dt0.001", "w");
    fid3 = fopen("Extended_var_NVT_N127_rho0.20_K1.0_dt0.001", "w");
    ...
    for (int step = 0; step < max_step; step++)
    {
        ...
        if (step % 100 == 0)
        {
            fprintf(fid1, "%.12lf\t %.12lf\t %.12lf\t %.12lf\t %.12lf\t %.12lf\n ", 
                            KE/N, RE/N, PE/N, E/N, E_s/N, s*(E+E_s-H_nose0)/N );
        ...
        //     {
        //         printf("\n Avg Energy: %lf\n", E_avg/N);
        //         printf("Energy Matched. Break in step %d \n", step);
        //         break;
        //     }
        // }
